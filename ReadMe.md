...
Этапы:
1.  Реализовать функцию trajectory(x0, v0, m, M, t) для расчета траектории тела m в гравитационном поле тела M. Предполагается, что она будет использовать разностную схему Эйлера с пересчетом. На вход функция получает начальные координаты тела, массу объекта, вокруг которого оно вращается, массу самого тела, начальную скорость и колличество шагов. Функция возвращает массивы координат.
...
Реализовать меню для выбора вида вывода графиков: с анимацией или без.
